...
public class faculty_signup_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_signup_activity);

        signupf = findViewById(R.id.signupf);
        email = findViewById(R.id.signup_faculty_email);
        name = findViewById(R.id.signup_faculty_name);
        id = findViewById(R.id.signup_faculty_number);
        password = findViewById(R.id.signup_faculty_password);
        confirmpassword = findViewById(R.id.signup_faculty_confirm_password);
            ...
            firebaseUser.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        ...
                        reff = firebaseDatabase.getReference("users").child("Faculty").child(firebaseAuth.getUid());
                        userinfo userinfo;
